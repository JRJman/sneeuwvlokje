...
let vlokje = {
    divMaken: function() {
        ...
        div.className = 'div__vlokje';
        document.getElementById('uitslag').appendChild(div);
        this.vlokjeOpvullen();
    },

    vlokjeOpvullen: function () {
        let vlokjes = document.getElementsByClassName('div__vlokje');
        for (let i=0; i<vlokjes.length; i++){
            vlokjes[i].innerHTML = codeSVGvlok;
        }
    }
};
